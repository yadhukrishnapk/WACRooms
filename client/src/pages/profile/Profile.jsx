  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center pt-16">
      ...
      <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 w-full max-w-md">
        <h1 className="text-2xl font-light mb-6 pb-4 border-b border-gray-100 tracking-wide">Profile</h1>
        {userDetails ? (
          <div className="space-y-6">
            <div className="flex flex-col">
              <span className="text-sm uppercase tracking-wider text-gray-500 mb-1">Name</span>
            ...
            <div className="flex flex-col">
              <span className="text-sm uppercase tracking-wider text-gray-500 mb-1">Email</span>
              <span className="text-lg text-gray-800">
            ...
            {userDetails.avatar ? (
              <div className="flex flex-col items-center pt-4">
                <span className="text-sm uppercase tracking-wider text-gray-500 mb-3">Avatar</span>
              ...
              <div className="flex flex-col items-center pt-4">
                ...
                <p className="text-gray-400 text-sm mt-2 italic">No avatar available</p>
              </div>
            )}
          </div>
        ) : (
